...
var css="* {\n  margin: 0px;\n  padding: 0px;\n}\nbody {\n  background-color: #ddd;\n}\n.app {\n  max-width: 640px;\n  width: 100%;\n  padding: 0 0px;\n  font-family: monospace;\n  font-size: 16px;\n  position: relative;\n  bottom: 0px;\n  top: 0px;\n  margin: auto;\n  height: 100%;\n}\n.app .navigation {\n  position: absolute;\n  bottom: 0px;\n  left: 0px;\n  right: 0px;\n  padding: 5px;\n  background-color: #fff;\n  text-align: center;\n}\n.app .navigation li {\n  display: inline;\n  padding: 0px 5px;\n  border-left: 1px #666 solid;\n  text-align: center;\n}\n.app .navigation li.selected {\n  font-weight: bold;\n}\n.app .navigation li:first-child {\n  border-left: 0px;\n}\n.listSelect {\n  background-color: white;\n  margin-bottom: 10px;\n  height: 28px;\n  padding-top: 8px;\n  overflow-y: auto;\n}\n.listSelect li {\n  display: table-cell;\n  padding: 0 20px;\n}\n.listSelect li.selected {\n  font-weight: bold;\n}\n.listsPage .addNew {\n  background-color: white;\n  margin: 5px;\n  padding: 5px;\n}\n.listsPage .addNew label {\n  width: 120px;\n  display: inline-block;\n  overflow: hidden;\n}\n.table li {\n  margin: 0px 8px;\n  padding: 5px 5px;\n  height: 20px;\n  overflow: hidden;\n  background-color: white;\n  transition: 0.3s linear height;\n  line-height: 24px;\n}\n.table li .prop {\n  display: block;\n  padding-left: 13px;\n}\n.table li .prop .propName {\n  display: none;\n  color: #636363;\n  padding-right: 4px;\n}\n.table li .prop:first-child {\n  padding-left: 3px;\n}\n.table li:hover {\n  height: initial;\n}\n.table li:hover .propName {\n  display: inline;\n}\n.table li:hover .headline {\n  display: none;\n}\n.table li:nth-child(ODD) {\n  background-color: #F9F9F9;\n}\n.table li button {\n  float: right;\n}\n.storePage {\n  text-align: center;\n  font-size: 30px;\n}\n.storePage * {\n  color: black;\n  padding: 60px;\n  text-decoration: none;\n}\n.storePage input {\n  padding: 4px;\n  font-size: 20px;\n}\n.definitionsPage .back {\n  margin-top: 30px;\n}\n.definitionsPage ul {\n  padding: 5px 5px;\n}\n.definitionsPage ul li {\n  position: relative;\n  background-color: white;\n  min-height: 24px;\n  padding-top: 8px;\n  height: 24px;\n  overflow: hidden;\n}\n.definitionsPage ul li:hover {\n  height: initial;\n}\n.definitionsPage ul li:nth-child(ODD) {\n  background-color: #F9F9F9;\n}\n.definitionsPage ul li label {\n  padding: 0px 17px;\n}\n.definitionsPage ul li button.deleteButton {\n  position: absolute;\n  right: 8px;\n}\n.definitionsPage ul li select {\n  position: absolute;\n  right: 80px;\n}\n.definitionsPage ul .metaOption {\n  margin: 0 28px;\n}\n.definitionsPage ul .metaOption li {\n  height: 14px;\n}\nbutton {\n  background-color: white;\n  box-shadow: 1px 1px 2px black;\n  border-width: 0px;\n  padding: 2px 10px;\n  margin: 3px;\n}\nbutton:active {\n  margin: 4px 4px;\n  box-shadow: none;\n}\ninput {\n  background-color: white;\n  border: 1px solid lightgray;\n}\nselect {\n  background-color: white;\n}\nul {\n  list-style-type: none;\n}\n.page {\n  position: absolute;\n  top: 0px;\n  left: 0px;\n  right: 0px;\n  bottom: 30px;\n  overflow: auto;\n}\n";require("lessify")(css),module.exports=css;

},{"lessify":12}],9:[function(require,module,exports){
module.exports={definitions:{template:function(e){var n,t="";Array.prototype.join;t+='<div class="definitionsPage">\n    ';var s=e.sections.definitions.selected;if(t+="\n    ",s){t+="\n     ";var l=e.data._meta.schemas[e.sections.definitions.selected].fields;t+='\n        <h2 class="listHeadline">'+(null==(n=e.sections.definitions.selected)?"":_.escape(n))+" "+(null==(n=e.t("properties"))?"":n)+"</h2>\n        <ul>\n            ";for(var a in l)if(l[a]){var i=l[a];if(t+="\n                <li><label>"+(null==(n=a)?"":_.escape(n))+'</label>\n                    <select component="dataBind" prop="it.data._meta.schemas.'+(null==(n=s)?"":_.escape(n))+".fields."+(null==(n=a)?"":_.escape(n))+'.type" type="select">\n                        <option value="string"',"string"==i.type&&(t+=' selected="true"'),t+='>string</option>\n                        <option value="number"',"number"==i.type&&(t+=' selected="true"'),t+='>number</option>\n                        <option value="boolean"',"boolean"==i.type&&(t+=' selected="true"'),t+='>boolean</option>\n                        <option value="date"',"date"==i.type&&(t+=' selected="true"'),t+='>date</option>\n                        <option value="url"',"url"==i.type&&(t+=' selected="true"'),t+='>url</option>\n                        <option value="email"',"email"==i.type&&(t+=' selected="true"'),t+='>email</option>\n                        <option value="img"',"img"==i.type&&(t+=' selected="true"'),t+='>image</option>\n                        <option value="password"',"password"==i.type&&(t+=' selected="true"'),t+='>password</option>\n                        <option value="text"',"text"==i.type&&(t+=' selected="true"'),t+='>text</option>\n                        <option value="option"',"option"==i.type&&(t+=' selected="true"'),t+=">option</option>\n                    </select><!-- - "+(null==(n=JSON.stringify(l[a]))?"":_.escape(n))+'-->\n                    <button class="deleteButton" component="removeSchemaField" name="'+(null==(n=a)?"":_.escape(n))+'">'+(null==(n=e.t("delete"))?"":n)+"</button>\n                    ","option"==i.type){i.options||(i.options={}),t+='\n                        <div class="meteDetail options">\n                            <ul class="metaOption">\n                            ';for(var o in i.options)t+="\n                                <li>"+(null==(n=o)?"":_.escape(n))+":"+(null==(n=i.options[o])?"":_.escape(n))+'<button component="meta_optionRemoveButton" property="'+(null==(n=a)?"":_.escape(n))+'" index="'+(null==(n=o)?"":_.escape(n))+'">'+(null==(n=e.t("delete"))?"":n)+"</button></li>\n                            ";t+='\n                            </ul>\n                            <button component="meta_optionAdd" property="'+(null==(n=a)?"":_.escape(n))+'">'+(null==(n=e.t("add option"))?"":n)+"</button>\n                        </div>\n                    "}t+="\n                </li>\n        <!-- "+(null==(n="string"==l[a].type?" selected":"")?"":_.escape(n))+" -->\n            "}t+='\n        </ul>\n        <button component="addNewSchemaField">'+(null==(n=e.t("add property"))?"":n)+'</button>\n        <div class="back" component="set" prop="it.sections.definitions.selected">'+(null==(n=e.t("back"))?"":n)+"</div>\n     "}else{t+='\n        <h2 class="listsHeadline">'+(null==(n=e.t("lists"))?"":n)+'<button component="createList">'+(null==(n=e.t("new"))?"":n)+'</button></h2>\n        <ul class="listDefinitionsList">\n            ';for(var a in e.data._meta.schemas)t+='<li>\n                <span component="set" prop="it.sections.definitions.selected" value="'+(null==(n=a)?"":_.escape(n))+'">'+(null==(n=a)?"":_.escape(n))+'</span>\n                <button component="removeList" name="'+(null==(n=a)?"":_.escape(n))+'">'+(null==(n=e.t("delete"))?"":n)+"</button>\n            </li>";t+="\n        </ul>\n     "}return t+="\n</div> "}},forms:{template:function(e){var n="";Array.prototype.join;return n+='<div class="formsPage">',e.data._meta.forms&&e.data._meta.forms.length||(n+="\n    there is currently no form defined\n"),n+="</div>"}},lists:{template:function(e){var n,t="";Array.prototype.join;t+='<div class="listsPage">\n    ';var s=e.sections.lists.currentListName,l=Object.keys(e.data);l=l.filter(function(n){return Array.isArray(e.data[n])});var a=e.data[s];if(e.data._meta.schemas)var i=e.data._meta.schemas[s];var o=[];if(a&&a[0]&&(o=Object.keys(e.data._meta.schemas[s].fields)),t+='\n    \n    <ul class="listSelect">\n        ',l.forEach(function(e){t+='\n            <li class="item '+(null==(n=s==e?"selected ":"")?"":n)+'" component="set" prop="it.sections.lists.currentListName" value="'+(null==(n=e)?"":n)+'">'+(null==(n=e)?"":n)+"</li>\n        "}),t+="\n    </ul>\n    \n    \n    ",a&&a.length&&(t+='\n        <ul class="table">\n        ',a.forEach(function(e,l){t+='\n            <li><div class="prop headline"> ',o.forEach(function(s,l){3>l&&(t+=""+(null==(n=e[s])?"":_.escape(n))+", ")}),t+="</div>\n                ",o.forEach(function(s){if(t+='\n                <div class="prop">\n                    <span class="propName">'+(null==(n=s)?"":_.escape(n))+': </span>\n                    <span class="value">\n                        ',i)switch(i.fields[s].type){case"option":t+=""+(null==(n=i.fields[s].options[e[s]])?"":_.escape(n));break;case"img":t+='<img src="'+(null==(n=e[s])?"":_.escape(n))+'" width="200px" />';break;default:t+=""+(null==(n=e[s])?"":_.escape(n))}else t+=""+(null==(n=e[s])?"":_.escape(n))+"\n                        ";t+="\n                    </span>\n                </div>\n                "}),t+='\n                <button component="removeListItem" name="'+(null==(n=s)?"":_.escape(n))+'" index="'+(null==(n=l)?"":n)+'">delete</button>\n            </li>\n        '}),t+="\n        </ul>\n    "),t+="\n    ",i){t+='\n    <div class="addNew">\n        <ul>\n            ';for(var p in i.fields){var c=i.fields[p];switch(t+="\n                <li>\n                    <label>"+(null==(n=p)?"":_.escape(n))+"</label>",c.type){case"number":t+='<input component="dataBind" prop="it.sections.lists.newValues.'+(null==(n=p)?"":_.escape(n))+'" type="number" value="'+(null==(n=e.sections.lists.newValues[p]||"")?"":_.escape(n))+'"/>';break;case"boolean":t+='<input component="dataBind" type="checkbox" prop="it.sections.lists.newValues.'+(null==(n=p)?"":_.escape(n))+'" checked="'+(null==(n=e.sections.lists.newValues[p]||"")?"":_.escape(n))+'"/>';break;case"date":t+='<input type="date" component="dataBind" prop="it.sections.lists.newValues.'+(null==(n=p)?"":_.escape(n))+'" value="'+(null==(n=e.sections.lists.newValues[p]||"")?"":_.escape(n))+'"/>';break;case"url":t+='<input type="url" component="dataBind" prop="it.sections.lists.newValues.'+(null==(n=p)?"":_.escape(n))+'" value="'+(null==(n=e.sections.lists.newValues[p]||"")?"":_.escape(n))+'"/>';break;case"img":t+='<input type="url" component="dataBind" prop="it.sections.lists.newValues.'+(null==(n=p)?"":_.escape(n))+'" value="'+(null==(n=e.sections.lists.newValues[p]||"")?"":_.escape(n))+'"/>';break;case"email":t+='<input type="email" component="dataBind" prop="it.sections.lists.newValues.'+(null==(n=p)?"":_.escape(n))+'" value="'+(null==(n=e.sections.lists.newValues[p]||"")?"":_.escape(n))+'"/>';break;case"password":t+='<input type="password" component="dataBind" prop="it.sections.lists.newValues.'+(null==(n=p)?"":_.escape(n))+'" value="'+(null==(n=e.sections.lists.newValues[p]||"")?"":_.escape(n))+'"/>';break;case"text":t+='<textarea component="dataBind" prop="it.sections.lists.newValues.'+(null==(n=p)?"":_.escape(n))+'">'+(null==(n=e.sections.lists.newValues[p]||"")?"":_.escape(n))+"</textarea>";break;case"option":t+='\n                    <select component="dataBind" prop="it.sections.lists.newValues.'+(null==(n=p)?"":_.escape(n))+'">\n                        ';for(var u in c.options)t+='\n                        <option value="'+(null==(n=u)?"":_.escape(n))+'"',e.sections.lists.newValues[p]==u&&(t+=' selected="true"'),t+=">"+(null==(n=c.options[u])?"":_.escape(n))+"</option>\n                        ";t+="\n                    </select>\n                    ";break;case"string":default:t+='<input component="dataBind" prop="it.sections.lists.newValues.'+(null==(n=p)?"":_.escape(n))+'" value="'+(null==(n=e.sections.lists.newValues[p]||"")?"":_.escape(n))+'"/>'}t+="\n                </li>\n            "}t+='\n        </ul>\n        <button component="addNewItem">add</button>\n    </div>\n    '}return t+="\n</div>"}},main:{template:function(e){var n,t="";Array.prototype.join;switch(t+='<div class="app">\r\n    <div class="page">\r\n    ',e.section){case"lists":t+=""+(null==(n=e.tM.render("./lists",e))?"":n);break;case"forms":t+=""+(null==(n=e.tM.render("./forms",e))?"":n);break;case"definitions":t+=""+(null==(n=e.tM.render("./definitions",e))?"":n);break;case"store":t+=""+(null==(n=e.tM.render("./store",e))?"":n)}return t+='\r\n    </div>\r\n    \r\n    <ul class="navigation">\r\n        <li class="item '+(null==(n="lists"==e.section?"selected ":"")?"":n)+'" component="set" prop="it.section" value="lists">'+(null==(n=e.t("lists"))?"":n)+'</li>\r\n        <!--<li class="item '+(null==(n="forms"==e.section?"selected ":"")?"":n)+'" component="set" prop="it.section" value="forms">'+(null==(n=e.t("forms"))?"":n)+'</li>-->\r\n        <li class="item '+(null==(n="definitions"==e.section?"selected ":"")?"":n)+'" component="set" prop="it.section" value="definitions">'+(null==(n=e.t("definitions"))?"":n)+'</li>\r\n        <li class="item '+(null==(n="store"==e.section?"selected ":"")?"":n)+'" component="set" prop="it.section" value="store">'+(null==(n=e.t("load"))?"":n)+" / "+(null==(n=e.t("save"))?"":n)+"</li>\r\n    </ul>\r\n</div>\r\n"}},store:{template:function(e){var n,t="";Array.prototype.join;return t+='<div class="storePage">\n    <div component="loadFile">'+(null==(n=e.t("load"))?"":n)+'</div>\n    <a href="data:test/json;base64,'+(null==(n=btoa(JSON.stringify(e.data)))?"":n)+'" download="'+(null==(n=e.sections.store.saveName)?"":_.escape(n))+'">'+(null==(n=e.t("save"))?"":n)+"</a>\n    <p><label>"+(null==(n=e.t("name"))?"":n)+':</label><input component="dataBind" prop="it.sections.store.saveName" value="'+(null==(n=e.sections.store.saveName)?"":_.escape(n))+'" /></p>\n</div>'}}};
...
var TreeAct = (function() {
    ...
    function updateNode(xml, org) {
        if (xml.tagName !== org.tagName){
            ...
            var newRoot = createRootNode(xml);
            while (org.node.firstChild) {
                newRoot.appendChild(org.node.firstChild);
            }
            org.node.parentNode.replaceChild(newRoot, org.node)
            org.node = newRoot;
        }
